package fr.jhamon.scpbrowser.model.exception;

/**
 * Error thrown if an exception happens during session operation (conenction,
 * read, write)
 *
 * @author J.Hamon
...
public class SessionException extends Exception {
  ...
  private static final long serialVersionUID = -6848312901268771806L;
